...
public class GetPointerMapping implements RequestHandler {
	...
	public void handleRequest(
		...
		final byte[] mappings = mapping.getMappings();
		final XOutputStream outputStream = response.respond(mapping.getNumberOfButtons(), mappings.length);
		response.padHeader();
