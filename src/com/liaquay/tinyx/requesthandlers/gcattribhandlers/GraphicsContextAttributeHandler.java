...
public interface GraphicsContextAttributeHandler {
	public void read(final XInputStream inputStream, final GraphicsContext graphicsContext) throws IOException;
	public void write(final XOutputStream outputStream, final GraphicsContext graphicsContex) throws IOException;
}
