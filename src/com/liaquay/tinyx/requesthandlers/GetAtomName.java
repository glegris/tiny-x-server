...
public class GetAtomName implements RequestHandler {
	...
	public void handleRequest(
		...
		// TODO check this does not require a memory allocation
		final byte[] bytes = atom.getText().getBytes();
		final XOutputStream outputStream = response.respond(1, bytes.length);
