...
public class Server extends Client {
	...
	public Client allocateClient() {
		...
		if(clientId < 0) {
			...
			// TODO Resource.SERVER_BIT is set so that resources allocated server side are distinct from those 
			// generated by the client. Think this code could be more graceful.
