...
public class TrueColorMap extends ColorMap {
	...
	private static final Map<String, Color> NAMED_COLOR_MAP = new TreeMap<String, Color>();
	...
	static {
		for(final String s : NAMED_COLOURS) {
			...
			c._r = Integer.parseInt(t[0]);
			c._g = Integer.parseInt(t[1]);
			c._b = Integer.parseInt(t[2]);
			final String n = t[3];
