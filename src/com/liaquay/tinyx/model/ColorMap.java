...
public abstract class ColorMap extends AbstractResource {
	...
	public abstract boolean isReadOnlyColor(final int pixel);
	...
	public abstract int getRGB(final int pixel);
	...
	public static class Color {
		...
		public Color(final int r, final int g, final int b) {
			_r = r << 8; _g = g << 8; _b = b << 8;
			_rgb = r << 16 | g <<8 | b;
		}
		
		public int getExactRed() { return _r; }
		public int getExactGreen() { return _g; }
		public int getExactBlue() { return _b; }
		public int getRGB() { return _rgb; }
	}

	protected static final Map<String, Color> NAMED_COLOR_MAP = new TreeMap<String, Color>();
	
	private static String[] NAMED_COLOURS={
		"255 250 250 snow",
	...
	static {
		for(final String s : NAMED_COLOURS) {
