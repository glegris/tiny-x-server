...
public class DestroyNotifyFactoryImpl implements DestroyNotifyFactory {

	public static DestroyNotifyFactory FACTORY = new DestroyNotifyFactoryImpl();
	
	@Override
	public Event create(final Window event,
			final Window window) {

		return new EventImpl(Event.DestroyNotify, 0) {
			@Override
